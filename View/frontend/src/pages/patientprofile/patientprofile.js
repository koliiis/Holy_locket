...
function Patientprofile() {
    ...
    <div className="body11">
        ...
        <h2 className="h22">Степан Дмитрук</h2>
        <img className="img22" src={img2}/>
        <img className="img33" src={img3}/>
        <div className='div11'><p className='p11'>Чоловік</p><img className="img44" src={img5}/></div>
        <div className='div22'><p className='p11'>03.11.2004</p><img className="img44" src={img4}/></div>
        <div className='div22'><p className='p11'>holy_locket@gmail.com</p><img className="img44" src={img6}/></div>
        <div className='div33'><p className='p11'>Україна, Київ</p><img className="img44" src={img7}/></div>
        <div className='div44'><p className='p11'>+38(038)038-03-80</p><img className="img44" src={img8}/></div>
